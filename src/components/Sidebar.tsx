    ...
    <>
      ...
      <aside className={cn(
          ...
          <div className="flex-1 flex flex-col min-h-0 space-y-6 overflow-hidden">
            ...
            {tags.length > 0 && (
              <div className="shrink-0">
                <label className="text-[10px] uppercase tracking-widest text-slate-500 font-bold mb-3 block">Filter by Tags</label>
            ...
            <div className="flex-1 flex flex-col min-h-0">
              <label className="text-[10px] uppercase tracking-widest text-slate-500 font-bold mb-3 block shrink-0">Recent Entries</label>
        ...
        <div className="mt-auto p-6 border-t border-slate-800 shrink-0">
          <button 
            onClick={onNew}
            className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-sm font-medium transition-all shadow-lg shadow-indigo-500/20 flex items-center justify-center gap-2 group"
          >
            <Plus className="w-4 h-4" />
            <span className="flex-1 text-left">New Entry</span>
            <kbd className="hidden lg:inline-flex h-5 select-none items-center gap-0.5 rounded border border-indigo-500 bg-indigo-700/50 px-1.5 font-mono text-[10px] font-bold text-indigo-200">
              ⌘N
            </kbd>
          </button>
        </div>
